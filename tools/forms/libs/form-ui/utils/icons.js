...
export default class FormIcons {
  ...
  static getIconSvg(name) {
    ...
    switch (name) {
      case 'sliders': // form mode
        return `<svg ${common}><line x1="21" y1="4" x2="14" y2="4"></line><line x1="10" y1="4" x2="3" y2="4"></line><line x1="21" y1="12" x2="12" y2="12"></line><line x1="8" y1="12" x2="3" y2="12"></line><line x1="21" y1="20" x2="16" y2="20"></line><line x1="12" y1="20" x2="3" y2="20"></line><circle cx="12" cy="4" r="2"></circle><circle cx="8" cy="12" r="2"></circle><circle cx="16" cy="20" r="2"></circle></svg>`;
      case 'code': // raw mode
        return `<svg ${common}><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg>`;
      case 'trash':
      ...
      case 'panel-right': // simple sidebar/panel icon
        const panelSpec = 'width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"';
        return `<svg ${panelSpec}>
          <rect x="2.5" y="3" width="19" height="18" rx="2"></rect>
      ...
      case 'rotate-ccw': // reset
        return `<svg ${common}><polyline points="1 4 1 10 7 10"></polyline><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"></path></svg>`;
      default:
        return '';
    }
  }
